	...
	let fsizedoc = '1'.repeat(10)    
     ...
     if (buffer) try { (type = await conn.getFile(buffer), buffer = type.data) } catch { buffer = buffer }
          ...
          forwardedNewsletterMessageInfo: {
            newsletterJid: '120363287210013365@newsletter',
            newsletterName: '『༆』𝒁𝒆𝒛𝒐 𝑩𝒐𝒕࿐𝒄𝒉𝒂𝒏𝒏𝒆𝒍᭄《', 
            serverMessageId: '' }, 
                ...options
                }
                })
...
let canalId = ["120363287210013365@newsletter", "120363287210013365@newsletter", "120363287210013365@newsletter", "120363287210013365@newsletter"]
let canalNombre = ["『༆』𝒁𝒆𝒛𝒐 𝑩𝒐𝒕࿐𝒄𝒉𝒂𝒏𝒏𝒆𝒍᭄《", "『༆』𝒁𝒆𝒛𝒐 𝑩𝒐𝒕࿐𝒄𝒉𝒂𝒏𝒏𝒆𝒍᭄《", "『༆』𝒁𝒆𝒛𝒐 𝑩𝒐𝒕࿐𝒄𝒉𝒂𝒏𝒏𝒆𝒍᭄《", "『༆』𝒁𝒆𝒛𝒐 𝑩𝒐𝒕࿐𝒄𝒉𝒂𝒏𝒏𝒆𝒍᭄《"]
